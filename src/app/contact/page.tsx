...
export default function ContactPage() {
    ...
    return (
        <main className="min-h-screen bg-white-sand">
            ...
            <Navbar onOpenModal={() => setIsModalOpen(true)} currentPage="contact" />

            {/* Hero Section */}
            <section className="relative h-[400px] bg-gradient-to-br from-ocean-blue via-sky-azure to-dark-navy overflow-hidden">
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        ...
                        >
                            <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold text-dark-navy mb-2">Get Property Info</h3>
                            <p className="text-gray-600 mb-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                        ...
                        <div className="bg-white rounded-2xl p-2 shadow-lg border border-gray-200 overflow-hidden">
                            <div className="rounded-xl overflow-hidden h-full min-h-[400px]">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d109467.19488!2d-113.54!3d31.32!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86d079ba74ba14f3%3A0xd50e6739f9a50e3a!2sPuerto%20Pe%C3%B1asco%2C%20Sonora%2C%20Mexico!5e0!3m2!1sen!2sus!4v1000000000000!5m2!1sen!2sus"
                                    width="100%"
                                    height="100%"
